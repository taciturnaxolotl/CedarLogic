...
export interface Document {
  ...
  /** Zoom by whole wheel notches about a CSS-pixel point, keeping it under the cursor. */
  zoomAt(notches: number, px: number, py: number): void;
  /** The same, by a possibly fractional number of steps. */
  zoomAtBy(steps: number, px: number, py: number): void;
